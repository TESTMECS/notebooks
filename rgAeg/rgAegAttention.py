...
# 98.5% accuracy with 7,862 Params.   
# check uv run rgAegAttention.py --help for options
...
class NormalityNormalization(nn.Module):
    ...
    def extra_repr(self):
        return "{normalized_shape}, eps={eps}, elementwise_affine={elementwise_affine}, noise_factor={noise_factor}".format(  # noqa: E501
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="RGAEG x RetroInfer demo with Opt. Attention Tokens"
    )
    parser.add_argument(
